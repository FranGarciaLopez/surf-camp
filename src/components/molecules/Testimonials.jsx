              ...
              <section className="bg-gray-900 py-16 px-4 md:px-12 text-white">
                     ...
                     <div className="mx-auto grid gap-10 md:grid-cols-3">
                            {testimonialsData.map(({ id, name, role, photo, quote }) => (
                                   <div
                                          key={id}
                                          className="relative group bg-gray-800/60 border border-cyan-500 rounded-3xl p-6 shadow-2xl backdrop-blur-lg transition-transform duration-500 hover:scale-[1.03] hover:border-cyan-400"
                                   >
                                          {/* Hover glow */}
